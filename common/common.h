...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NAV_FLYINGROVER_TAKEOFF=86, /* Takeoff from ground using flying rover mode, and transition to multicopter flight with specified heading. |Empty| Front transition heading.| Empty| Yaw angle. NaN to use the current system yaw heading mode (e.g. yaw towards next waypoint, yaw to home, etc.).| Latitude| Longitude| Altitude|  */
   MAV_CMD_NAV_FLYINGROVER_LAND=87, /* Land using flyingrover mode |Empty| Empty| Approach altitude (with the same reference as the Altitude field). NaN if unspecified.| Yaw angle. NaN to use the current system yaw heading mode (e.g. yaw towards next waypoint, yaw to home, etc.).| Latitude| Longitude| Altitude (ground level)|  */
...
/** @brief Direction of VTOL transition */
#ifndef HAVE_ENUM_FLYINGROVER_TRANSITION_HEADING
#define HAVE_ENUM_FLYINGROVER_TRANSITION_HEADING
typedef enum FLYINGROVER_TRANSITION_HEADING
{
   FLYINGROVER_TRANSITION_HEADING_VEHICLE_DEFAULT=0, /* Respect the heading configuration of the vehicle. | */
   FLYINGROVER_TRANSITION_HEADING_NEXT_WAYPOINT=1, /* Use the heading pointing towards the next waypoint. | */
   FLYINGROVER_TRANSITION_HEADING_TAKEOFF=2, /* Use the heading on takeoff (while sitting on the ground). | */
   FLYINGROVER_TRANSITION_HEADING_SPECIFIED=3, /* Use the specified heading in parameter 4. | */
   FLYINGROVER_TRANSITION_HEADING_ANY=4, /* Use the current heading when reaching takeoff altitude (potentially facing the wind when weather-vaning is active). | */
   FLYINGROVER_TRANSITION_HEADING_ENUM_END=5, /*  | */
} FLYINGROVER_TRANSITION_HEADING;
#endif
...
#include "./mavlink_msg_avoidance_status.h"
#include "./mavlink_msg_vcu_base_status.h"
#include "./mavlink_msg_vcu_command_velocity.h"
#include "./mavlink_msg_vcu_bms_status.h"
#include "./mavlink_msg_vcu_direct_can_ctrl.h"

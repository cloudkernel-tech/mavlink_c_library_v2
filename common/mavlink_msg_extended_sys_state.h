...
typedef struct __mavlink_extended_sys_state_t {
 ...
 uint8_t flyingrover_state; /*<  The flying rover state. Is set to FLYINGROVER_STATE_UNDEFINED if the state is unknown.*/
} mavlink_extended_sys_state_t;

#define MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN 3
#define MAVLINK_MSG_ID_EXTENDED_SYS_STATE_MIN_LEN 3
#define MAVLINK_MSG_ID_245_LEN 3
#define MAVLINK_MSG_ID_245_MIN_LEN 3

#define MAVLINK_MSG_ID_EXTENDED_SYS_STATE_CRC 69
#define MAVLINK_MSG_ID_245_CRC 69
...
#define MAVLINK_MESSAGE_INFO_EXTENDED_SYS_STATE { \
    ...
    {  { "vtol_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_extended_sys_state_t, vtol_state) }, \
         ...
         { "flyingrover_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_extended_sys_state_t, flyingrover_state) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_EXTENDED_SYS_STATE { \
 ...
 * @param flyingrover_state  The flying rover state. Is set to FLYINGROVER_STATE_UNDEFINED if the state is unknown.
...
static inline uint16_t mavlink_msg_extended_sys_state_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t vtol_state, uint8_t landed_state, uint8_t flyingrover_state)
{
    ...
    _mav_put_uint8_t(buf, 2, flyingrover_state);
    ...
    packet.flyingrover_state = flyingrover_state;
...
{
    return mavlink_msg_extended_sys_state_pack(system_id, component_id, msg, extended_sys_state->vtol_state, extended_sys_state->landed_state, extended_sys_state->flyingrover_state);
}
...
{
    return mavlink_msg_extended_sys_state_pack_chan(system_id, component_id, chan, msg, extended_sys_state->vtol_state, extended_sys_state->landed_state, extended_sys_state->flyingrover_state);
}
...
static inline void mavlink_msg_extended_sys_state_send(mavlink_channel_t chan, uint8_t vtol_state, uint8_t landed_state, uint8_t flyingrover_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN];
    _mav_put_uint8_t(buf, 0, vtol_state);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_extended_sys_state_send(chan, extended_sys_state->vtol_state, extended_sys_state->landed_state, extended_sys_state->flyingrover_state);
#else
 ...
 */
static inline void mavlink_msg_extended_sys_state_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t vtol_state, uint8_t landed_state, uint8_t flyingrover_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field flyingrover_state from extended_sys_state message
 *
 * @return  The flying rover state. Is set to FLYINGROVER_STATE_UNDEFINED if the state is unknown.
 */
static inline uint8_t mavlink_msg_extended_sys_state_get_flyingrover_state(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_extended_sys_state_decode(const mavlink_message_t* msg, mavlink_extended_sys_state_t* extended_sys_state)
{
    ...
    extended_sys_state->flyingrover_state = mavlink_msg_extended_sys_state_get_flyingrover_state(msg);
#else

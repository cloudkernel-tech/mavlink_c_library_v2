...
#define MAVLINK_MSG_ID_VCU_COMMAND_VELOCITY 342
...
#define MAVLINK_MSG_ID_VCU_COMMAND_VELOCITY_LEN 24
#define MAVLINK_MSG_ID_VCU_COMMAND_VELOCITY_MIN_LEN 24
#define MAVLINK_MSG_ID_342_LEN 24
#define MAVLINK_MSG_ID_342_MIN_LEN 24

#define MAVLINK_MSG_ID_VCU_COMMAND_VELOCITY_CRC 107
#define MAVLINK_MSG_ID_342_CRC 107
...
static inline uint16_t mavlink_msg_vcu_command_velocity_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const float *linear_vel, const float *angular_vel)
{
...
{
    return mavlink_msg_vcu_command_velocity_pack(system_id, component_id, msg, vcu_command_velocity->linear_vel, vcu_command_velocity->angular_vel);
}
...
{
    return mavlink_msg_vcu_command_velocity_pack_chan(system_id, component_id, chan, msg, vcu_command_velocity->linear_vel, vcu_command_velocity->angular_vel);
}
...
static inline void mavlink_msg_vcu_command_velocity_send(mavlink_channel_t chan, const float *linear_vel, const float *angular_vel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VCU_COMMAND_VELOCITY_LEN];
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_vcu_command_velocity_send(chan, vcu_command_velocity->linear_vel, vcu_command_velocity->angular_vel);
#else
 ...
 */
static inline void mavlink_msg_vcu_command_velocity_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const float *linear_vel, const float *angular_vel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
